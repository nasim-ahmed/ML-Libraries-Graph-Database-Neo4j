...
from thesis.src.dataloader.utils import write_json, write_pkl, load_json
#for debugging
...
def convert_into_mmap(data_dir, save_dir, csv_name, n_cols=None, n_rows=100000):
    ...
    """
    csv_to_cols = {'diagnoses': 520, 'diagnoses_1033': 1034, 'labels': 5, 'flat': 93} # including patient column
...
if __name__ == '__main__':
    # path_file = '/media/nasim/31c299f0-f952-4032-9bd8-001b141183e0/ML-Libraries-Graph-Database-Neo4j/PyG-Neo4j/paths.json'
    # paths = load_json(path_file)
    # data_dir = paths['eICU_path']
    # save_dir = paths['data_dir']
    data_dir = '/media/nasim/31c299f0-f952-4032-9bd8-001b141183e0/ML-Libraries-Graph-Database-Neo4j/PyG-Neo4j/app/eICU_data'
    save_dir = '/media/nasim/31c299f0-f952-4032-9bd8-001b141183e0/ML-Libraries-Graph-Database-Neo4j/PyG-Neo4j/app/data'
