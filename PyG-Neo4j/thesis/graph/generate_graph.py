...
def get_device_and_dtype():
    ...
    dtype = torch.cuda.BFloat16Tensor if device.type == 'cuda' else torch.sparse.BFloat16Tensor
    return device, dtype
...
def free_gpu_cache():
    ...
    print("GPU Usage after emptying clear the cache")
    gpu_usage()
...
def create_score_matrix(diagnoses, freq_adjustment=None, debug=False):
    ...
    if freq_adjustment is not None:
        ...
        test_file = open('../../../PyG-Neo4j/dataset/graph/test.out', 'ab')
...
if __name__ == '__main__':
    ...
    graph_dir = './../../PyG-Neo4j/dataset/graph/'


    # eICU_path = '/home/nasim/Documents/ML-Libraries-Graph-Database-Neo4j/PyG-Neo4j/dataset/eicudata/'
    # graph_dir = '/home/nasim/Documents/ML-Libraries-Graph-Database-Neo4j/PyG-Neo4j/dataset/graph/'
    ...
    print(all_diagnoses.head)
    # create_score_matrix(all_diagnoses,freq_adjustment=freq_adjustment)
